...
//
// CPE 422 Project 1 Tier 2 part b
// Pressing the pushbutton (p8.16) on BBB 2 turns on the LED (p9.12) on BBB 1.
// This code is the publisher for the pushbutton on BBB2. Will be read by BBB2 when subscriber  is 
// running ./bbb1pbLED_s
