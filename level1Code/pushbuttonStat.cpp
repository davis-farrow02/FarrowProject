// code name: pushbuttonStat.cpp
// code by: Davis Farrow
//
// CPE 422 Project 1 part 4
// this code uses a pushbutton interfaced to the BBB, a status indicator on AIO, and the
// GPIO class. The pushbutton controls the status indicator. When pressed the status indicator turns
// green and when not pressed the status indicator turns red. This simulates a button
// sensor on a window, which is pressed when window is opened.
