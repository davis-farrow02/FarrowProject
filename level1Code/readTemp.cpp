...
//
// CPE 422 Project 1 part 1
// This code uses a temperature sensor interfaced to the BBB. This code publishes the 
// sensor temperature data to AIO feed while using the AnalogIn class
