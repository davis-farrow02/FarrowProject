// code name: tempThresh.cpp
// code by: Davis Farrow
//
// CPE 442 Project 1 part 2
// This code receives the temperature from AIO. If the temperature is less than a threshold of 30 degree celcius, the system turns on USR0 LED. Must use AnalogIn and LED classes.
...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    ...
    temperature < THRESHOLD ? led0.turnOn() : led0.turnOff();
